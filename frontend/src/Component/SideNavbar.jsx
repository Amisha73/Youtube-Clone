...
const SideNavbar = ({sideNavbar}) => {
  ...
  return (
    <div className={sideNavbar ? 'no-scrollbar flex flex-col box-border h-[92vh] overflow-y-auto z-10 fixed top-14 left-0 w-60 px-3 py-2 bg-black text-white' : 'hidden transition '}>
